...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         */
        // false : le logo est embarqué en base64 directement depuis le disque
        // (voir InvoiceController::logoDataUri), pas via une URL HTTP.
        // Une requête HTTP vers notre propre serveur depuis l'intérieur de la
        // requête PDF cause un deadlock avec `php artisan serve` (mono-thread).
        'enable_remote' => false,
