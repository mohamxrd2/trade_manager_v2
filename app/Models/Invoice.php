...
class Invoice extends Model
{
    ...
    /**
     * Get the stock transactions generated by this invoice.
     */
    ...
    /**
     * Get the formatted total, dans la devise choisie par l'utilisateur
     * (user_settings.currency — FCFA par défaut, pas l'euro).
     */
    public function getFormattedTotalAttribute(): string
    {
        try {
            ...
            $currency = $this->user?->settings?->currency ?? 'FCFA';

            return self::formatMoney((float) ($this->total ?? 0), $currency);
        } catch (\Exception $e) {
            return '0 FCFA';
        }
    }
    ...
    /**
     * Format un montant selon une devise (parmi celles supportées par
     * user_settings.currency : FCFA, XOF, EUR, USD).
     */
    public static function formatMoney(float $amount, string $currency): string
    {
        return match ($currency) {
            ...
            'XOF', 'FCFA' => number_format($amount, 0, ',', ' ') . ' FCFA',
    ...
    public static function generateInvoiceNumber(string $userId): string
    {
        ...
        // Tri par longueur puis par valeur : au-delà de 99 999 factures/an, un
        // simple tri alphabétique sur "invoice_number" classerait "100000" avant
        // "99999" (comparaison caractère par caractère), ce qui casserait la
        // détection du "dernier" numéro.
